...
describe('Positioning', () => {
  ...
  it('should position the element top-left', () => {
    ...
    const isInViewport = positioning.positionElements(element, targetElement, 'top-left');
  ...
  it('should position the element top-center', () => {
    const isInViewport = positioning.positionElements(element, targetElement, 'top');
  ...
  it('should position the element top-right', () => {
    const isInViewport = positioning.positionElements(element, targetElement, 'top-right');
  ...
  it('should position the element bottom-left', () => {
    const isInViewport = positioning.positionElements(element, targetElement, 'bottom-left');
  ...
  it('should position the element bottom-center', () => {
    const isInViewport = positioning.positionElements(element, targetElement, 'bottom');
  ...
  it('should position the element bottom-right', () => {
    const isInViewport = positioning.positionElements(element, targetElement, 'bottom-right');
  ...
  it('should position the element left-top', () => {
    const isInViewport = positioning.positionElements(element, targetElement, 'left-top');
  ...
  it('should position the element left-center', () => {
    const isInViewport = positioning.positionElements(element, targetElement, 'left');
  ...
  it('should position the element left-bottom', () => {
    const isInViewport = positioning.positionElements(element, targetElement, 'left-bottom');
  ...
  it('should position the element right-top', () => {
    const isInViewport = positioning.positionElements(element, targetElement, 'right-top');
  ...
  it('should position the element right-center', () => {
    const isInViewport = positioning.positionElements(element, targetElement, 'right');
  ...
  it('should position the element right-bottom', () => {
    const isInViewport = positioning.positionElements(element, targetElement, 'right-bottom');
