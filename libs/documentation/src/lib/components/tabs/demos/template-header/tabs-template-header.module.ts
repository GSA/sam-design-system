...
@NgModule({
  imports: [CommonModule, SdsTabsModule, IconModule, NgxBootstrapIconsModule.pick({ fileExcel, table, tablet })],
  declarations: [TabsTemplateHeaderComponent],
  exports: [TabsTemplateHeaderComponent],
  bootstrap: [TabsTemplateHeaderComponent],
})
