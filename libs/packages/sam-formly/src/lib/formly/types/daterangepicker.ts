    ...
    <div *ngIf="!field.hide" class="display-flex">
      ...
      >
        <input
          matStartDate
          [attr.aria-label]="
            field.fieldGroup[0]?.templateOptions?.placeholder || 'Start Date'
          "
          [formlyAttributes]="field.fieldGroup[0]"
          [placeholder]="
            field.fieldGroup[0]?.templateOptions?.placeholder || 'mmm-dd-yyyy'
          "
        ...
        <input
          matEndDate
          [attr.aria-label]="
            field.fieldGroup[1]?.templateOptions?.placeholder || 'End Date'
          "
          [formlyAttributes]="field.fieldGroup[1]"
          [placeholder]="
            field.fieldGroup[1]?.templateOptions?.placeholder || 'mmm-dd-yyyy'
          "
