...
const DEMOS = {
  unevenStepsStepper: {
    ...
    path:
      'libs/documentation/src/lib/components/formly-stepper/demos/uneven-steps',
    files: [
      {
  ...
  advanced: {
    ...
    files: [
      ...
      {
        name: 'subawardee.component.ts',
        source: require('!!raw-loader!./demos/advanced/subawardee.component'),
      },
      {
        name: 'subawardee.component.html',
        source: require('!!raw-loader!./demos/advanced/subawardee.component.html'),
      },
    ],
  },
  uswdsStepper: {
    ...
    path:
      'libs/documentation/src/lib/components/formly-stepper/demos/uswds-stepper',
    files: [
      {
