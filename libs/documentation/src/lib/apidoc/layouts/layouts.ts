  ...
  interfaces: [
    {
      ...
      file:
        'libs/packages/layouts/src/lib/feature/system-alert/model/alert.model.ts',
      type: 'interface',
      sourceCode:
    ...
    },
    {
      ...
      file:
        'libs/packages/layouts/src/lib/feature/search-list-layout/model/search-list-layout.model.ts',
      type: 'interface',
      sourceCode:
      ...
      methods: [
        {
          ...
          line: 62,
          description:
            '<p>Method to get the takes it takes in the SearchParameters and returns SearchResult object</p>\n',
          jsdoctags: [
            {
              name: {
                pos: 840,
  ...
  injectables: [
    {
      ...
      id:
        'injectable-SdsDrawerCommunicationService-9539dd5998c81e048cecea3b5b23c472',
      file:
        'libs/packages/layouts/src/lib/feature/subheader/drawer-communication.service.ts',
      properties: [
        {
      ...
      properties: [
        {
          ...
          optional: true,
          description:
            '<p>Default values to use during initialization when there is none in url.</p>\n',
          line: 99,
        },
        {
  ...
  components: [
    {
      ...
      file:
        'libs/packages/layouts/src/lib/feature/actions-menu/actions-menu.component.ts',
      encapsulation: [],
      entryComponents: [],
      inputs: [],
      outputs: [],
      ...
      templateData:
        '<!-- Button that triggers menu (sdsMenuTriggerFor) -->\n<button class="sds-button sds-button--circular" [class.sds-button--primary]="model.trigger.type === \'primary\'" [class.sds-button--shadow]="model.trigger.shadow" [class.sds-button--small]="size === \'sm\'" [sdsMenuTriggerFor]="menu">\n<sds-icon [icon]="[\'bs\', \'three-dots-vertical\']" [size]="\'2x\'"></sds-icon>\n  <span class="usa-sr-only">Toggle Actions</span>\n</button>\n\n<!-- Menu content -->\n<sds-menu #menu="sdsMenu" [size]="size" xPosition="before" overlapTrigger="true">\n    <!-- Menu header (optional) -->\n    <sds-menu-header>Actions</sds-menu-header>\n    <!-- Menu items -->\n    <button *ngFor="let button of model.actions" (click)="clicks.emit(button.id)" sds-menu-item>\n    {{ button.text }}\n  </button>\n</sds-menu>',
    },
    {
      name: 'SdsDrawerContentComponent',
      id:
        'component-SdsDrawerContentComponent-21b2bb10d400ca219c87f7c494365a70',
      file:
        'libs/packages/layouts/src/lib/feature/subheader/subheader.component.ts',
      encapsulation: [],
      entryComponents: [],
      inputs: [],
      outputs: [],
      ...
      implements: ['OnInit'],
      templateData:
        '<ng-container *ngIf="drawerContentTemplate && isDrawerOpen" [ngTemplateOutlet]="drawerContentTemplate" >\n</ng-container>\n',
    },
    {
      name: 'SdsFeedbackComponent',
      id: 'component-SdsFeedbackComponent-c857a6f52f480cd45900568b7e7139b1',
      file:
        'libs/packages/layouts/src/lib/feature/sds-feedback/sds-feedback.component.ts',
      encapsulation: [],
      entryComponents: [],
      inputs: [],
      outputs: [],
    ...
    },
    {
      ...
      inputsClass: [
        ...
        },
        {
          name: 'model',
          description:
            '<p>Model used for the different display portions of the footer</p>\n',
          line: 23,
          type: 'FooterModel',
        },
      ],
    ...
    },
    {
      ...
      inputsClass: [
        ...
        },
        {
          name: 'model',
          description:
            '<p>Model used for the different display portions of the header</p>\n',
          line: 42,
          type: 'HeaderModel',
        },
        {
      ...
      methodsClass: [
        ...
        },
        {
          ...
          line: 126,
          description:
            '<p>Finds the navigation element by id in the header model</p>\n',
          jsdoctags: [
            {
              name: {
                pos: 2753,
        ...
        },
        {
          ...
          line: 59,
          description:
            '<p>Takes in a text string and removes all white space characters and returns the new string</p>\n',
          jsdoctags: [
            {
              name: {
                pos: 1266,
    ...
    },
    {
      ...
      implements: ['OnInit'],
      templateData:
        "<button (click)=\"onDrawerOpenClose($event)\" class=\"sds-button sds-button--circular margin-top-2px tablet:margin-top-0\">\n  <sds-icon\n    [icon]=\"isOpen ? ['bs', 'arrow-up'] : ['bs', 'arrow-down']\"\n  ></sds-icon>\n</button>",
    },
    {
      name: 'SdsSystemAlertComponent',
      id: 'component-SdsSystemAlertComponent-78b53dbbbd05e7b6d44833892e5fd6b4',
      file:
        'libs/packages/layouts/src/lib/feature/system-alert/system-alert.component.ts',
      encapsulation: [],
      entryComponents: [],
      inputs: [],
      outputs: [],
      ...
      inputsClass: [
        {
          name: 'alerts',
          description:
            '<p>List of alerts to display. When the list contains only one item, the description of the alert will also\nbe displayed. Description text may contain html</p>\n',
          line: 14,
          type: 'Alert[]',
        },
      ],
      ...
      methodsClass: [
        ...
        },
        {
          ...
          line: 37,
          description:
            '<p>Fired when &#39;See All Alerts&#39; button is clicked. Emits the seeAllAlerts event</p>\n',
        },
        {
        ...
        },
        {
          ...
          line: 53,
          description:
            '<p>On mobile view - hide/display list of alerts based on toggle button </p>\n',
          jsdoctags: [
            {
              name: 'alertsContent',
              type: 'HTMLElement',
    ...
    },
    {
      ...
      propertiesClass: [
        ...
        },
        {
          ...
          optional: false,
          description:
            '<p>Value to track whether API call in progress for purpose of showing loading\ntemplate</p>\n',
          line: 114,
        },
        {
          name: 'loadingArray',
          ...
          optional: false,
          description:
            '<p>Used in ngFor to create multiple copies of the same loading row.</p>\n',
          line: 119,
        },
        {
          name: 'page',
      ...
      methodsClass: [
        ...
        },
        {
          ...
          line: 178,
          description:
            '<p>updates the filter and set the page number to 1 and calls imported service</p>\n',
          modifierKind: [114],
          jsdoctags: [
            {
              name: {
    ...
    },
    {
      ...
      id: 'component-SideToolbarComponent-07c20c0e9fae4dc4c3703ac2b4b30632',
      file:
        'libs/packages/layouts/src/lib/feature/side-toolbar/side-toolbar.component.ts',
      encapsulation: [],
      entryComponents: [],
      inputs: [],
      outputs: [],
