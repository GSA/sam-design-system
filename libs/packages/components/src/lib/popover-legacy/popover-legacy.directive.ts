...
export class SdsPopoverLegacyDirective implements AfterViewInit, OnChanges {
  ...
  @Input()
  set sdsPopoverLegacy(value: string | TemplateRef<any> | HTMLParagraphElement) {
    this._sdsPopoverContent = this.handlePopoverSection(value, 'content');
  }

  get sdsPopoverLegacy(): string | TemplateRef<any> | HTMLParagraphElement {
