...
import { NgxBootstrapIconsModule, search, arrowLeftCircleFill, infoCircle } from 'ngx-bootstrap-icons';

@NgModule({
  imports: [CommonModule, FormsModule, SdsIconModule, NgxBootstrapIconsModule.pick({search, arrowLeftCircleFill, infoCircle, alertError})],
