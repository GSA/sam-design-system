...
@Component({
  selector: 'sds-formly-radio-advanced',
  templateUrl: './formly-radio-advanced.component.html',
})
export class FormlyRadioAdvancedComponent {
  form = new FormGroup({});
  model: any = {};
        ...
        options: [
          {
            ...
            description: ['13240 GREENBURY CIRCUIT SUITE 200', 'Sterling, VA 20165 United States'],
          },
          {
            value: 'nonprofit',
            label:
