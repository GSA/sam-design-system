  ...
  template: ` <div class="usa-input-group maxw-mobile-lg position-relative">
    ...
    <ng-container>
      <div class="usa-input-prefix" aria-hidden="true">
        ...
        <usa-icon *ngIf="props.prefixIcon" [icon]="props.prefixIcon" size="lg" class="font-sans-xs"></usa-icon>
      </div>
      ...
      <div class="usa-input-suffix" aria-hidden="true">
        ...
        <usa-icon *ngIf="props.suffixIcon" [icon]="props.suffixIcon" size="lg" class="font-sans-xs"></usa-icon>
      </div>
    </ng-container>
  </div>`,
})
