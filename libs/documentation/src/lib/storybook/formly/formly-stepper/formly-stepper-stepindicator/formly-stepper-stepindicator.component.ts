...
@Component({
  selector: 'sds-formly-stepper-stepindicator',
  templateUrl: './formly-stepper-stepindicator.component.html',
})
export class FormlyStepperStepIndicatorComponent {
  form = new FormGroup({});
  model: any = {};
  ...
  fields: FormlyFieldConfig[] = [
    {
      ...
      templateOptions: {
        ...
        hideOptional: true,
        tabClass: 'sds-stepper--formly',
        stepindicatorTabChange: true,
