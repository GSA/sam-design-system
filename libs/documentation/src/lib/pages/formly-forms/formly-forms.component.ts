  ...
  fields: FormlyFieldConfig[] = [
    ...
    },
    {
      ...
      fieldGroup: [
        {
          template:
            '<h3>Phone Number</h3> Your phone number is the primary number associated with your vendor',
        },
      ],
    },
    {
      ...
      fieldGroup: [
        ...
        {
          className:
            'margin-bottom-0 grid-col-3 desktop:grid-col-4 display-none desktop:display-inline-block',
          type: 'input',
          key: 'extension',
          templateOptions: {
            label: 'Extension',
    ...
    {
      className:
        ' margin-top-(-1) grid-col-8 display-block desktop:display-none',
      type: 'button',
