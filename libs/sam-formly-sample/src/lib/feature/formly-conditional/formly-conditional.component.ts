  ...
  fields: FormlyFieldConfig[] = [
    
    {
      ...
      },
      {
        ...
        fieldGroup: [
          {
            template: "<h4 class='margin-top-5 margin-bottom-1'>Dropdpwn Checkbox Selection :</h4><p class='margin-top-0'>Dropdown selection will reveal the respective checkbox.</p>"
          },
          {
            key: 'checkbox',
            type: 'select',
      ...
      },
      {
        ...
        fieldGroup: [
          {
            template: "<h4 class='margin-top-5 margin-bottom-1'>Hide Input :</h4><p class='margin-top-0'>Clicking on checkbox will hide the input field.</p>"
          },
          {
            key: 'inputField',
            type: 'input',
      ...
      },
      {
        ...
        fieldGroup: [
          {
            template: "<h4 class='margin-top-5 margin-bottom-1'>Disabled Input :</h4><p class='margin-top-0'>Type in First Name input will enabled the Last Name input field.</p>"
          },
          {
      ...
      },
      {
        ...
        fieldGroup: [
          {
            template: "<h4 class='margin-top-5 margin-bottom-1'>Cascaded :</h4><p class='margin-top-0'>Cascaded Select value chage base on the another dropdown (using observable).</p>"
          },
          {
            key: 'sport',
            type: 'select',
          ...
          },
          {
            ...
            hooks: {
              onInit: field => {
                const teams = [
                  { id: '1', name: 'Option1 (FirstSelect- Option1)', sportId: '1' },
                  { id: '2', name: 'Option1 (FirstSelect- Option2)', sportId: '1' },
                  { id: '3', name: 'Option2 (FirstSelect- Option1)', sportId: '2' },
          ...
          },
          {
            ...
            hooks: {
              onInit: field => {
                const players = [
                  { id: '1', name: 'Option1 (Option1 (FirstSelect- Option1))', teamId: '1' },
                  { id: '2', name: 'Option2 (Option1 (FirstSelect- Option1))', teamId: '1' },
                  { id: '3', name: 'Option1 (Option1 (FirstSelect- Option2))', teamId: '2' },
                  { id: '4', name: 'Option2 (Option1 (FirstSelect- Option2))', teamId: '2' },
                  { id: '5', name: 'Option1 (Option2 (FirstSelect- Option1))', teamId: '3' },
                  { id: '6', name: 'Option2 (Option2 (FirstSelect- Option1))', teamId: '3' },
                  { id: '7', name: 'Option1 (Option2 (FirstSelect- Option2))', teamId: '4' },
