...
@Component({
  selector: 'sds-table-custom-classes',
  templateUrl: './table-custom-classes.component.html',
})
export class TableCustomClassesComponent {
  ...
  data = [
    {
      ...
      classesToApply: 'sds-table__row--error',
    },
    {
      id: 2,
      firstName: 'Letti',
