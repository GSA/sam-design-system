const LAYOUTS = {
    ...
    "classes": [
        {
            ...
            "id": "class-DownloadConfiguration-1ea037f57b05b3ac670adfea2ed2e9c5",
            "file": "libs/packages/layouts/src/lib/feature/download/download.component.ts",
            "type": "class",
    ...
    "components": [
        ...
        {
            "name": "SdsDownloadComponent",
            "id": "component-SdsDownloadComponent-1ea037f57b05b3ac670adfea2ed2e9c5",
            "file": "libs/packages/layouts/src/lib/feature/download/download.component.ts",
            "encapsulation": [],
            "entryComponents": [],
            "inputs": [],
            ...
            "inputsClass": [
                {
                    "name": "configurations",
                    "defaultValue": "new DownloadConfiguration()",
                    "line": 21,
            ...
            "templateData": "<button type=\"button\" (click)=\"openDialog()\" class=\"usa-button\">\n  {{ configurations.buttonText }}\n</button>\n"
        },
        {
            "name": "SdsDownloadDialogComponent",
            "id": "component-SdsDownloadDialogComponent-3affa2885b7715e433b0a2f255e72890",
            "file": "libs/packages/layouts/src/lib/feature/download-dialog/download-dialog.component.ts",
            "encapsulation": [],
            "entryComponents": [],
            "inputs": [],
            "outputs": [],
            ...
            "styles": [],
            "templateUrl": [
                "./download-dialog.component.html"
            ],
            "viewProviders": [],
            "inputsClass": [],
            "outputsClass": [],
            "propertiesClass": [
                ...
                {
                    "name": "dialogRef",
                    "type": "SdsDialogRef<SdsDownloadDialogComponent>",
                    "optional": false,
                    "description": "",
                    "line": 20,
                    "modifierKind": [
            ...
            "templateData": "<form [formGroup]=\"form\" (ngSubmit)=\"onSubmit()\">\n  <div *ngIf=\"configurations.title\" sds-dialog-title>\n    {{ configurations.title }}\n  </div>\n  <div *ngIf=\"configurations.infoMessage\">{{ configurations.infoMessage }}</div>\n  <div sds-dialog-content>\n    <formly-form\n      [form]=\"form\"\n      [fields]=\"fields\"\n      [options]=\"options\"\n      [model]=\"model\"\n    ></formly-form>\n  </div>\n  <div sds-dialog-actions>\n    <button\n      class=\"usa-button usa-button--base\"\n      (click)=\"onCancel()\"\n      type=\"button\"\n    >\n      {{ configurations.cancelButtonText }}\n    </button>\n    <button class=\"usa-button\" type=\"submit\">\n      {{ configurations.submitButtonText }}\n    </button>\n  </div>\n</form>\n"
        },
        {
